...
import Message from "./pagecontent/Messaging/index";
    ...
    <>
      ...
      <div className="content-wrapper my-3">
        <section className="content px-4 mt-4">
          <Switch>
            <Route path="/admin/notification" render={() => <Message />} />
            ...
            <Route
              path="/admin/operationtheatre"
              render={() => <OperationTheater />}
            />
            ...
            <Route
              path="/admin/settings/humanResource"
              render={() => <HumanResourceSetting />}
            />
            <Route
              path="/admin/settings/pathology"
              render={() => <PathologySettings />}
            />
            <Route
              path="/admin/settings/radiology"
              render={() => <RadiologySettings />}
            />
            <Route
            ...
            />
            <Route
              path="/admin/settings/frontOffice"
              render={() => <SettingsFrontOffice />}
            />
            <Route
            ...
            <Route
              path="/admin/inPatient/:patientId"
              render={() => <IpdPatient />}
            />
            <Route
              path="/admin/ipd1/diagnosis/:patientId"
              render={() => <IpdDiagnosis />}
            />
            <Route
              path="/admin/ipd1/consultentRegister/:patientId"
              render={() => <ConsultantRegister />}
            />
            <Route
              path="/admin/ipd1/ipdPresciption/:patientId"
              render={() => <IpdPrescription />}
            />
            <Route
              path="/admin/ipd1/Charges/:patientId"
              render={() => <IpdCharges />}
            />
            <Route
              path="/admin/opdPatient/:patientId"
              render={() => <OpdPatient />}
            />
            <Route
              path="/admin/diagnosis/:patientId"
              render={() => <Diagnosis />}
            />
            <Route
              path="/admin/patient/charges/:patientId"
              render={() => <OpdCharges />}
            />
            <Route
              path="/admin/patient/bill/:patientId"
              render={() => <OpdBill />}
            />
