           ...
           <li className="nav-item has-treeview shadow p-1">
            ...
            <li className="nav-item has-treeview shadow p-1">
                 ...
                 <ul className="nav nav-treeview text-dark bg-light">
                      <li className="nav-item"><NavLink className="nav-link py-1 text-dark" to="/admin/finance/income"><i class="text-xs fas fa-angle-right"></i> Income </NavLink></li>
                      <li className="nav-item"><NavLink className="nav-link py-1 text-dark" to="/admin/finance/expense"><i class="text-xs fas fa-angle-right"></i> Expense</NavLink></li>
                 </ul>
            </li>
            <li className="nav-item has-treeview shadow p-1">
