...
export default function HumanResource(props) {
  ...
  <div className='btn-group p-0'>
    ...
    <button className={'btn btn-xs  btn-light ml-1 ' } style={{marginLeft:'0.5px !important'}} onClick={()=>history.push('/admin/addstaff')}><i className='fa fa-plus'/> Add Staff</button>
