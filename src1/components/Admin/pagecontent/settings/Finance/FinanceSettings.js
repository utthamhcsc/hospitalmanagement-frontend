...
<div className='col-md-2 w-100'>
    ...
    <Link to='/admin/settings/finance/incomeHead' className='list-group-item'>Income Head</Link>
    <Link to='/admin/settings/finance/expenseHead' className='list-group-item'>Expense Head</Link>
        </ul>
...
<Route path={'/admin/settings/finance/expenseHead'} render={()=><ExpenseHead/>}/>
