          ...
          <i class="fas fa-chevron-square-right    "></i>    Ipd Charges
            ...
            <div className="btn-group p-0">
              ...
              <button
                ...
                onClick={() =>
                history.push(`/admin/myIpd/discharge/prescription/${patientId}`)
              }
              ...
              <button
                ...
                onClick={() =>
                history.push(`/admin/myIpd/discharge/consultantRegister/${patientId}`)
              }
                class="btn btn-light text-xs  btn-xs  ml-1"
              >
                {" "}
              ...
              <button
                ...
                onClick={() =>
                history.push(`/admin/myIpd/discharge/diagnosis/${patientId}`)
              }
                class="btn btn-light text-xs  btn-xs  ml-1"
              >
                {" "}
              ...
              <button
                ...
                onClick={() =>
                history.push(`/admin/myIpd/discharge/payment/${patientId}`)
              }
                class="btn btn-light text-xs  btn-xs  ml-1"
              >
                {" "}
