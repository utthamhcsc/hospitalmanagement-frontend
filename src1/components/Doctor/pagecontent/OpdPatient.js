...
<NavLink to={`/doctor/diagnosis/${myopdId}`} class="btn btn-light text-xs  btn-xs  ml-1"> Diagnosis</NavLink>  
<NavLink to={`/doctor/patient/charges/${myopdId}`} class="btn btn-light text-xs  btn-xs  ml-1"> Charges</NavLink>  
<NavLink to={`/doctor/patient/bill/${myopdId}`} class="btn btn-light text-xs  btn-xs  ml-1"> Bill</NavLink>  
