    ...
    <div>
      <div className="row p-0 justify-content-between align-items-center mx-0 px-3 py-2 bg-primary">
        ...
        <div>
          ...
          <NavLink type="button" to='/accountant/humanResource/leaves' className="btn btn-xs btn-light ml-1">
...
<table className='table table-bordered'>
    ...
    <tbody>
       ...
       <td className='text-left'>{item.staffId}</td>
        ...
        <td className='text-left'> <button onClick={()=>history.push('/accountant/humanResource/addStaff/'+item.staffId)} className='btn btn-xs btn-light'><i className='fa fa-pencil'/></button>
