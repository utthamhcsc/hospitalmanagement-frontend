          ...
          >
            ...
            <div className="btn-group p-0">
              ...
              <button
                ...
                onClick={() =>
                history.push(`/patient/myIpd/prescription/${patientId}`)
              }
              ...
              <button
                ...
                onClick={() =>
                history.push(`/patient/myIpd/charges/${patientId}`)
              }
                class="btn btn-light text-xs  btn-xs  ml-1"
              >
                {" "}
              ...
              <button
                ...
                onClick={() =>
                history.push(`/patient/myIpd/consultantRegister/${patientId}`)
              }
                class="btn btn-light text-xs  btn-xs  ml-1"
              >
                {" "}
              ...
              <button
                ...
                onClick={() =>
                history.push(`/patient/myIpd/diagnosis/${patientId}`)
              }
                class="btn btn-light text-xs  btn-xs  ml-1"
              >
                {" "}
