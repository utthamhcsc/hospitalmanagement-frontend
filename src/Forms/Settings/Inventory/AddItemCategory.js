  ...
  const formik=useFormik({
   ...
   //    props.setdataSrc(data=>[...data,values])
      ...
      return (
        ...
        <div className="modal fade in" id="addItemCategory" >
                ...
                <div className="modal-body pt0 pb0">  
                  <div className="ptt10">
                    <div className="form-group">
                      ...
                      <input autocomplete={'off'}    type="text" className="form-control" {...formik.getFieldProps('itemCategory')} />
