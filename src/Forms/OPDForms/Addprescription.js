...
export default (props)=> {
 ...
 return (
    ...
    <div className="card ">
      <div class="modal-header "> <h5>Add Prescription </h5>
    ...
    enableReinitialize={true}
      ...
      Postdata('myopdprescription/add','POST',values).then(data=>{
         console.log(data);
       ...
       
   {
       ...
       <thead>
           ...
           <tbody>
                   ...
                   {
                     values && values.caseHistory && values.caseHistory.length?
...
<span class="text-danger">{touched.instruction?errors.instruction:''}</span>
      ...
      <div><b className='text-sm'>Footer</b></div>
       ...
       <button type='submit' className='btn btn-primary btn-sm mt-2' onClick={handleSubmit}>save</button>
      </form>
      }
       </Formik>
