...
React.useEffect(()=>{
  ...
  <div class="card ">
            <div class="card-header bg-primary"> Add Birth Record
                ...
                <form onSubmit={formik.handleSubmit}>
                 <div className="form-row">
                     ...
                     <div> Child Name <small class="req text-danger"> *</small>
                         <input type="text" className="form-control mt-1" value={formik.values.childName} onChange={(e)=>formik.setFieldValue('childName',e.target.value)}/>
                     ...
                     <div className="ml-2">Gender<small class="req text-danger"> *</small>
                         <select id="input" className="form-control mt-1" value={formik.values.gender} onChange={(e)=>formik.setFieldValue('gender',e.target.value)}>
                     ...
                     <div  className="ml-2">Weight<small class="req text-danger"> *</small>
                         <input type="number" className="form-control mt-1" value={formik.values.weight} onChange={(e)=>formik.setFieldValue('weight',e.target.value)}/>
                     ...
                     <div  className="ml-2">Child Photo
                         <input type="file" className="form-control mt-1"  onChange={(e)=>formik.setFieldValue('childPhotoFile',e.target.files[0])}/>
                     </div>
                     </div>
                 </div>
                 ...
                 <div className="form-row mt-2">
                     ...
                     <div className="">
                        <DatePicker autoComplete={false} className="form-control mt-1" 
                        value={formik.values.birthDate} style={{width:'100% !important'}} 
                        selected={new Date(formik.values.birthDate)=='Invalid Date'?'':new Date(formik.values.birthDate)} customInput={<input className="form-control mt-1"/>}  onChange={(data)=>formik.setFieldValue('birthDate',data)}/>
                     </div>
                     ...
                     <div  className="ml-2">Phone
                         <input type="number" className="form-control mt-1" value={formik.values.phone} onChange={(e)=>formik.setFieldValue('phone',e.target.value)} />
                     </div>
                     </div>
                     <div className="col-6">
                     <div  className="ml-2">Address
                         <input type="text" className="form-control mt-1" value={formik.values.address} onChange={(e)=>formik.setFieldValue('address',e.target.value)}/>
                     </div>
                     </div>
                 </div>
                 ...
                 <div className="form-row mt-2">
                     ...
                     <input id="input" className="form-control mt-1" 
                     ...
                     <div  className="ml-2">Mother Photo
                         <input type="file" className="mt-1"  onChange={(e)=>formik.setFieldValue('motherPhotoFile',e.target.files[0])}/>
                     </div>
                     </div>
                 </div>
                 ...
                 <div className="form-row mt-2">
                     <div className="col-6">
                         <div>Father Name</div>
                         <input type="text" className="form-control mt-1" value={formik.values.fatherName} onChange={(e)=>formik.setFieldValue('fatherName',e.target.value)}/>
                     </div>
                     <div className="col-6">
                         <div  className="ml-2">Father Photo
                         <input type="file" className="mt-1"  onChange={(e)=>formik.setFieldValue('fatherPhotoFile',e.target.files[0])}/>
                         </div>
                     </div>
                 </div>
                 ...
                 <div className="form-row mt-2">
                     <div className="col-6">
                         <div>Report</div>
                         <textarea id="input" className="form-control mt-1" value={formik.values.report} onChange={(e)=>formik.setFieldValue('report',e.target.value)}/>
                     </div>
                     <div className="col-6">
                         <div  className="ml-2">Attach Document
                         <input type="file" className="mt-1"  onChange={(e)=>formik.setFieldValue('file',e.target.files[0])}/>
                         </div>
                     </div>
                 </div>
                 <div className="mt-2">
                 <div>Any Other Responsible</div>
                 <input type="text" className="form-control mt-1" value={formik.values.responsibility} onChange={(e)=>formik.setFieldValue('responsibility',e.target.value)}/>
                 </div> 
