       ...
       
   {
       ...
       <thead>
           ...
           <tbody>
                  ...
                  {index==0? <td onClick={()=>arrayHelpers.push({appliedDate:'',doctorId,instruction:'',instructionDate:new Date(),ipdId:patientId})}><i className='fa fa-plus fa-lg text-primary'></i></td>
