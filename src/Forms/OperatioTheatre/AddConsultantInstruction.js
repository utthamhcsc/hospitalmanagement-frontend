...
export default (props)=> {
  ...
  React.useEffect(()=>{
    ...
    consultantInstruction:[{appliedDate:'',doctorId:'',instruction:'',instructionDate:new Date(),otid:props.id}],
       ...
       <thead>
           ...
           <tbody>
                 ...
                 <option> select Doctor</option>
                 {
                  ...
                  {index==0? <td onClick={()=>arrayHelpers.push({appliedDate:'',doctorId:props.doctorId,instruction:'',instructionDate:new Date(),otid:props.id})}><i className='fa fa-plus fa-lg text-primary'></i></td>
