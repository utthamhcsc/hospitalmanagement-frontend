...
const UserProfile = (props) => {
  ...
  return (
      <>
        <Link href="/receptionist/profile" class="nav-Link dropdown-toggle text-white" data-toggle="dropdown">
  ...
  <div className="widget-user-header bg-info">
    ...
    <h5 className="widget-user-desc">{localStorage.getItem('role')?localStorage.getItem('role'):'receptionist'}</h5>
  </div>
...
history.push('/receptionist/profile')
                  }}
