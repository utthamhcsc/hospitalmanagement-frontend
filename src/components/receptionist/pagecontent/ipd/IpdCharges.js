          ...
          <i class="fas fa-chevron-square-right    "></i>    Ipd Charges
            ...
            <div className="btn-group p-0">
              ...
              <button
                ...
                onClick={() =>
                history.push(`/receptionist/myIpd/prescription/${patientId}`)
              }
              ...
              <button
                ...
                onClick={() =>
                history.push(`/receptionist/myIpd/consultantRegister/${patientId}`)
              }
                class="btn btn-light text-xs  btn-xs  ml-1"
              >
                {" "}
              ...
              <button
                ...
                onClick={() =>
                history.push(`/receptionist/myIpd/diagnosis/${patientId}`)
              }
                class="btn btn-light text-xs  btn-xs  ml-1"
              >
                {" "}
              ...
              <button
                ...
                onClick={() =>
                history.push(`/receptionist/myIpd/payment/${patientId}`)
              }
                class="btn btn-light text-xs  btn-xs  ml-1"
              >
                {" "}
