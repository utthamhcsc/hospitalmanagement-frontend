...
const columnDefs=[{targets:-1,orderable:false,responsivePriority:1,createdCell:(td,cellData,rowData,row,col)=>ReactDOM.render(
    ...
    <button onClick={()=>props.setindex(rowData)} className={'btn btn-xs btn-success'} data-toggle='modal' data-target='#AddOpdPatient'><i className='fa fa-pencil'></i></button>
...
<button data-toggle="modal" data-target="#AddOpdPatient" onClick={()=>props.setindex({})} class="btn btn-light text-xs  btn-xs  ml-1"> <i class="fa fa-plus"></i> Add Patient</button>               
</div>
</li>
</ol>
</nav>
