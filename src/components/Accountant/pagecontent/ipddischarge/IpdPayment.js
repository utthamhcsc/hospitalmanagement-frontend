          ...
          >
            ...
            <div className="btn-group p-0">
              ...
              <button
                ...
                onClick={() =>
                history.push(`/accountant/myIpd/discharge/prescription/${patientId}`)
              }
              ...
              <button
                ...
                onClick={() =>
                history.push(`/accountant/myIpd/discharge/charges/${patientId}`)
              }
                class="btn btn-light text-xs  btn-xs  ml-1"
              >
                {" "}
              ...
              <button
                ...
                onClick={() =>
                history.push(`/accountant/myIpd/discharge/consultantRegister/${patientId}`)
              }
                class="btn btn-light text-xs  btn-xs  ml-1"
              >
                {" "}
              ...
              <button
                ...
                onClick={() =>
                history.push(`/accountant/myIpd/discharge/diagnosis/${patientId}`)
              }
                class="btn btn-light text-xs  btn-xs  ml-1"
              >
                {" "}
