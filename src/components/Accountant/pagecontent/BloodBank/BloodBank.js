...
export default function BloodBank(props)
 {
  ...
  <div className='btn-group p-0'>
    ...
    <NavLink to='/accountant/bloodbankstatus/donor' className='btn btn-xs btn-light mx-1'>
      <i className='fa fa-reorder'></i> Donor Details
    </NavLink>
    <NavLink to='/accountant/bloodbankstatus/issue' className='btn btn-xs btn-light mx-1'>
