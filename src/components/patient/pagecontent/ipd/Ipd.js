...
export default function Ipd(props) {
        ...
        ReactDOM.render(
          <BrowserRouter>
            <button
              ...
              onClick={() =>
                history.push(`/patient/myIpd/consultantRegister/${rowData.ipd.ipdId}`)
              }
            >
              {cellData}
            </button>
  ...
  React.useEffect(() => {
    Getdata("myIpd/get/patient/"+window.localStorage.getItem('userId')+"/NO").then(data => {
      console.log(data);
    setdataSrc(data);
    });
  }, []);
          ...
          >
            ...
            <div className="btn-group p-0">
              ...
              >
               ...
               <button
                onClick={() =>history.push('/patient/myIpd/discharge') }
