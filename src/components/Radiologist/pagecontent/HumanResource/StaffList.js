  ...
  return (
    <div>
      <div className="row p-0 justify-content-between align-items-center mx-0 px-3 py-2 bg-primary">
        ...
        <div>
          <NavLink type="button" to='/radiologist/humanResource/leaves' className="btn btn-xs btn-light ml-1">
        ...
        <label className='h6'>Role</label><small className='text-danger'>*</small>
          <div className="form-group border">
            ...
            <select id='sel' ref={myrole}  style={{ border: "none", width: "100%",padding:'2px' }}>
              ...
              <option value="radiologist">Admin</option>
                                                                            <option value="radiologist">Accountant</option>
...
<table className='table table-bordered'>
    ...
    <tbody>
       ...
       <td className='text-left'>{item.staffId}</td>
        ...
        <td className='text-left'> <button onClick={()=>history.push('/radiologist/humanResource/addStaff/'+item.staffId)} className='btn btn-xs btn-light'><i className='fa fa-pencil'/></button>
