...
export default function Pathology(props)
 {
  ...
  const [index1,setindex1]=React.useState({});
    ...
    const columnDefs=[{targets:-1,orderable:false,responsivePriority:1,createdCell:(td,cellData,rowData,row,col)=>ReactDOM.render(
      ...
      <button onClick={()=>setindex(rowData.p)} className={'btn btn-xs btn-success'} data-toggle='modal' data-target='#AddpathologyTest'><i className='fa fa-pencil'></i></button>
  ...
  <div className='btn-group p-0'>
    ...
    <NavLink to='/pathologist/pathology/testreport' className='btn btn-xs btn-light mx-1'>
