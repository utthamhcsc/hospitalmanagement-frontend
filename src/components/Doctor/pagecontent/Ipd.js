...
const history=useHistory();
   ...
   {targets:0,orderable:false,responsivePriority:1,createdCell:(td,cellData,rowData,row,col)=>ReactDOM.render(
    <BrowserRouter>
    <a onClick={()=>history.push(`/doctor/ipd1/consultentRegister/${rowData.ipdId}`)} href='javascript:void(0)'>{cellData}</a>
    </BrowserRouter>,td)}
    ...
    <NavLink to={ '/doctor/discharge'} activeClassName='active' class="btn btn-light text-xs  btn-xs ml-1 ">
