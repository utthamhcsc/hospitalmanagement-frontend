...
export default function Discharge() {
    const column=[{data:'name',title:'Name'},{data:'patientId',title:'Patient Id'},{data:'gender',title:'Gender'},{data:'phone',title:'Phone'},{data:'consulatant',title:'Consulatant'},{data:'admissionDate',title:'Admission Date'},{data:'dischargedDate',title:'Discharge Date'},{data:'charges',title:'Charges'},{data:'otherCharges',title:'Other Charges'},{data:'tax',title:'Tax'},{data:'discount',title:'Discount'},{data:'paidAmount',title:'Paid Amount'}]
