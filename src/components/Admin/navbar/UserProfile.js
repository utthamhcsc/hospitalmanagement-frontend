...
const UserProfile = (props) => {
  ...
  return (
      <>
        <Link href="/admin/profile" class="nav-Link text-black dropdown-toggle " data-toggle="dropdown">
              <img src={'dist/img/user2-160x160.jpg'} class="user-image" alt="User Image" alt='no img'/>
            </Link>
            <div class="dropdown-menu text-black dropdown-menu-right">
  ...
  <div className="widget-user-header ">
    ...
    <h5 className="widget-user-desc">{localStorage.getItem('role')?localStorage.getItem('role'):'admin'}</h5>
  </div>
