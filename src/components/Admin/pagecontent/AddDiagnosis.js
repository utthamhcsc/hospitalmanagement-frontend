    ...
    <div class="modal fade" id="addDiagnosis" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-md" role="document">
        <div class="modal-content" role="document">
          ...
          <div className="card ">
            <div className="card-header bg-primary">Add Diagnosis
            ...
            <form onSubmit={formik.handleSubmit}>
                <div className="border bg-light p-3">
                    ...
                    <input type="file" className="form-control mt-1"onChange={(e)=>formik.setFieldValue('document',e.target.files[0])}></input>
                    <div className="mt-2">Description</div>
                    <textarea className="form-control mt-1" rows="3" onChange={(e)=>formik.setFieldValue('description',e.target.value)}></textarea>
