...
export default () => {
  ...
  {data:'bedTypeName',title:'Contact No'},
  {data:'bedGroupName',title:'Vehicle Number'},
  {data:'bedGroupName',title:'Vehicle Model'},
  {data:'bedGroupName',title:'Driver Name'},
  {data:'bedGroupName',title:'Address'},
  {data:'bedGroupName',title:'Date'},
  {data:'bedGroupName',title:'Amount'},
  ...
  return (
    <div>
      <div className="row p-0 justify-content-between align-items-center mx-0 px-3 py-2 bg-primary">
        ...
        <div>
          <button type="button" data-toggle='modal' data-target='#addambulancecall' className="btn btn-xs btn-light ml-1">
