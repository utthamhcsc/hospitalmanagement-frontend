...
export default function NoticeBoard(props)
 {
  ...
  <div className='btn-group p-0'>
    ...
    <NavLink type="button" to={'/admin/messaging/newmessage'} activeClassName='active' className="btn btn-xs btn-light ml-1">
      <i className="fa fa-plus" /> Post New Message{" "}
     </NavLink>
          
    <NavLink type="button" to={'/admin/messaging/sendemail'} activeClassName='active' className="btn btn-light text-xs  btn-xs ml-1 ">
