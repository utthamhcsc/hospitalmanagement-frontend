...
export default () =>
<React.Fragment>
  <div className='d-flex flex-column align-items-start pl-md-5 bg-success'> 
...
<li className='list-group-item border-white bg-success mt-3 '>
...
<div>
<div className='h3 py-3 m-0 p-0 mx-2'>Follow Us On </div>
<div className=' py-4 mx-2 btn-group'>
